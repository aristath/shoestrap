...
if ( ! class_exists( 'Kirki' ) ) {
	...
	if ( class_exists( 'WP_Customize_Section' ) && ! class_exists( 'Shoestrap_Kirki_Installer_Control' ) ) {
		/**
		 ...
		 */
		class Shoestrap_Kirki_Installer_Control extends WP_Customize_Control {
	...
	if ( ! function_exists( 'shoestrap_kirki_installer_register' ) ) {
		/**
		...
		function shoestrap_kirki_installer_register( $wp_customize ) {
			...
			$wp_customize->add_control( new Shoestrap_Kirki_Installer_Control( $wp_customize, 'kirki_installer', array(
				'section' => 'kirki_installer',
			) ) );

		}
		add_action( 'customize_register', 'shoestrap_kirki_installer_register' );
	}
}
